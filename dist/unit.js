...
var List = function (_Container) {
  ...
  _createClass(List, null, [{
    key: 'create',
    value: function create(value) {
      var tagName = value.type === 'ordered' ? 'OL' : 'UL';
  ...
  _createClass(List, [{
    ...
    value: function optimize(context) {
      ...
      var next = this.next;
      if (next != null && next.prev === this && next.statics.blotName === this.statics.blotName && next.domNode.tagName === this.domNode.tagName && (next.domNode.getAttribute('data-checked') === this.domNode.getAttribute('data-checked') || next.domNode.getAttribute('type') === this.domNode.getAttribute('type'))) {
        next.moveChildren(this);
        next.remove();
      }
    }
